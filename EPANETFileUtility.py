...
"directory can be specified below."
                ...
                groupbox = wx.StaticBox(win.win, -1, _('Naming'))
                ...
                groupbox = wx.StaticBox(win.win, -1, _('Energy Usage'))
                groupsizer = wx.StaticBoxSizer(groupbox, wx.VERTICAL)
                midleftsizer.Add(groupsizer, 1, wx.GROW)
                ...
                groupbox = wx.StaticBox(win.win, -1, _('Dynamic Results'))
                groupsizer = wx.StaticBoxSizer(groupbox, wx.VERTICAL)
                midleftsizer.Add(groupsizer, 1, wx.GROW)
                ...
                st.SetValue(True)
                groupsizer.Add(st, 1, wx.GROW)
                m_export = wx.Button(win.win, -1, _("Export"))
