...
"c:\Program Files (x86)\GnuWin32\bin\xgettext.exe" --copyright-holder="Mark Morgan" -n -d EPANETFileUtility -o EPANETFileUtility.pot -L Python EPANETFileUtility.py
